...
public final class WatchConnectionManager {
    ...
    public void configureLan(String host,String pairingCode){String credential=identity.lanCredential();lan.configure(host,credential.isEmpty()?pairingCode:credential);}
